...
App menu bar macOS hiển thị quota Codex CLI (5-hour / weekly usage, reset time), đọc trực tiếp từ `codex app-server`. Xem chi tiết thiết kế ở [`docs/plan.md`](docs/plan.md).
